...
<!-- Card Section -->
{{-- <div class="max-w-4xl px-4 py-6 sm:px-4 lg:px-6 lg:py-8 mx-auto bg-slate-100 rounded-lg mb-6"> --}}

<div class="max-w-4xl px-4 py-6 sm:px-6 lg:px-8 lg:py-8 mx-auto bg-slate-50 ">
    <!-- Card -->
    <div class="rounded-xl shadow p-4 sm:p-7 dark:bg-neutral-900">
      <form wire:submit="update">
        ...
        <!-- End Col -->
        <div class="sm:col-span-9">
            <select wire:model="category_id" class=" bg-gray-50 py-3 px-4 pe-9 block w-full border-gray-500 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
        ...
        <div class="grid sm:grid-cols-12 gap-2 sm:gap-4 py-8 first:pt-0 last:pb-0 border-t first:border-transparent border-gray-200 dark:border-neutral-700 dark:first:border-transparent">
          ...
          <!-- End Col -->
          <div class="sm:col-span-9 flex justify-center">
            ...
            @else
                <img src="{{ asset('images/default-image.jpg') }}" alt="Default image" height="300px" width="300px" class="rounded-lg">
            @endif
        </div>
