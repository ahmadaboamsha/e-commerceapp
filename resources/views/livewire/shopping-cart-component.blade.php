<section class="bg-gray-900">
    ...
    <div class="mx-auto max-w-3xl">
      <header class="text-center flex gap-3">
        <h1 class="text-xl font-bold text-blue-500  sm:text-3xl">Your Cart:</h1>
        ...
        <ul class="space-y-4">
          @foreach($cartItems as $item)
            <li class="flex items-center gap-4">
              ...
              <div>
                <h3 class="text-m text-white">{{ $item->product->name }}</h3>
        ...
        <div class="mt-8 flex justify-end border-t border-gray-100 pt-8">
          <div class="w-screen max-w-lg space-y-4">
            <dl class="space-y-0.5 text-sm text-gray-700">
              ...
              <div class="flex justify-between !text-base font-medium text-blue-500">
                <dt>Total</dt>
                <dd>${{ $total }}</dd>
              </div>
            </dl>
