            ...
            @if (count($categories) > 0)
              ...
              <tr wire:key="{{$category->id}}">
                ...
                <td class="size-px whitespace-nowrap">
                  ...
                  <a wire:navigate class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-blue-500" href="/edit/{{ $category->id }}/category">
                    Edit
                  </a>
                  </div>
                </td>
                <td class="size-px whitespace-nowrap">
                  <div class="px-6 py-1.5">
                  <a wire:navigate wire:click="delete({{ $category->id }})"wire:confirm.prompt="Are you sure?\n\nType DELETE to confirm|DELETE"  class="inline-flex items-center gap-x-1 text-sm text-red-500 decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-red-500" href="">
                    Delete
                  </a>
                  </div>
                </td>
...
<div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-t border-gray-200 dark:border-neutral-700">
    ...
    <div class="flex items-center justify-center space-x-2">
      ...
      @else
        <a href="{{ $categories->previousPageUrl() }}" class="px-3 py-1 text-white bg-blue-600 rounded hover:bg-blue-700">Previous</a>
      @endif
      ...
      @if ($categories->hasMorePages())
        <a href="{{ $categories->nextPageUrl() }}" class="px-3 py-1 text-white bg-blue-600 rounded hover:bg-blue-700">Next</a>
      @else
