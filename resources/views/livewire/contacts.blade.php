<!-- Hire Us -->
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto bg-slate-300">
    <div class="max-w-xl mx-auto">
      <div class="text-center">
        <h1 class="text-3xl font-bold  sm:text-4xl text-blue-500">
          Contact us
        </h1>
        <p class="mt-1 text-gray-600 dark:text-neutral-900">
        ...
        <form>
          <div class="grid gap-4 lg:gap-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
              <div>
                <label for="hs-firstname-hire-us-2" class="block mb-2 text-sm text-gray-700 font-medium dark:text-black">First Name</label>
              ...
              <div>
                <label for="hs-lastname-hire-us-2" class="block mb-2 text-sm text-gray-700 font-medium dark:text-black">Last Name</label>
            ...
            <div>
              <label for="hs-work-email-hire-us-2" class="block mb-2 text-sm text-gray-700 font-medium dark:text-black">Work Email</label>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
              <div>
                <label for="hs-company-hire-us-2" class="block mb-2 text-sm text-gray-700 font-medium dark:text-black">Company</label>
              ...
              <div>
                <label for="hs-company-website-hire-us-2" class="block mb-2 text-sm text-gray-700 font-medium dark:text-black">Company Website</label>
            ...
            <div>
              <label for="hs-about-hire-us-2" class="block mb-2 text-sm text-gray-700 font-medium dark:text-black">Details</label>
